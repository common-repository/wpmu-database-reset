...
= 0.2.2 =
* Fix warning message in Customizer screen in some themes after database reset

= 0.2.1 =
* Fix plugin wiping out users and sites when used on the main website in network
